...
const Bio = () => {
  return (
    <section className="relative z-1 flex w-full max-w-[1248px] flex-col flex-nowrap items-center justify-center gap-10 overflow-hidden px-6 py-10">
      <div className="relative flex h-min w-full max-w-[640px] flex-row flex-wrap content-center items-center justify-center gap-2 overflow-visible p-0">
